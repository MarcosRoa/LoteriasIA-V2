// ============================================
// CAMINHO: api/statistics/engine/analyzers/GroupAnalyzer.ts
// ============================================
// ANÁLISE DE GRUPOS (DEZENAS)
// ============================================

export class GroupAnalyzer {
    calculate(dados: number[][], maxNumero: number, incluirZero: boolean = false): { grupo: string; quantidade: number; percentual: number }[] {
