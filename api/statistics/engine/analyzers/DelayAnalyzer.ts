// ============================================
// CAMINHO: api/statistics/engine/analyzers/DelayAnalyzer.ts
// ============================================
// ANÁLISE DE ATRASO DE NÚMEROS
// ============================================

export class DelayAnalyzer {
    calculate(dados: number[][], maxNumero: number, incluirZero: boolean = false): { numero: number; atraso: number }[] {
