// ============================================
// CAMINHO: api/statistics/engine/analyzers/TrendAnalyzer.ts
// ============================================
// ANÁLISE DE TENDÊNCIAS
// ============================================

export class TrendAnalyzer {
    calculate(dados: number[][], maxNumero: number, incluirZero: boolean = false, ultimosN: number = 30): { numero: number; quantidade: number }[] {
