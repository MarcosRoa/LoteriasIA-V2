// ============================================
// CAMINHO: api/generate/services/StatisticsContext.ts
// ============================================
...
export class StatisticsContext {
    ...
    constructor(dados: number[][]) {
        ...
        // Inicializar todos os analyzers com os mesmos dados
    ...
    /**
     * Retorna o timestamp da criação
     */
    getTimestamp(): number {
    ...
    /**
     * Verifica se o contexto está atualizado
     */
