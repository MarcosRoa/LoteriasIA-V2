// ============================================
// CAMINHO: api/generate/analysis/PatternAnalyzer.ts
// ============================================
...
export class PatternAnalyzer {
    ...
    /**
     * Detecta ciclos (números que aparecem em intervalos regulares)
     */
    private detectarCiclos(): void {
        ...
        for (const [num, data] of ciclos) {
            if (data.posicoes.length > 2) {
                ...
                // Verificar se há um intervalo predominante
    ...
    /**
     * Detecta intervalos entre números
     */
    ...
    /**
     * Detecta repetições rápidas (números que repetem em menos de 3 concursos)
     */
    ...
    /**
     * Retorna os melhores padrões (maior confiança)
     */
    ...
    /**
     * Gera números baseados em um padrão específico
     */
    gerarNumerosPorPadrao(padrao: Pattern, quantidade: number, maxNumero: number): number[] {
        ...
        switch (padrao.tipo) {
            ...
            case 'dezenas': {
                // Gerar números nas faixas especificadas
