...
export class DispersionAnalyzer {
    ...
    /**
     * Verifica se um número apareceu recentemente
     */
    ...
    /**
     * Retorna o conjunto de números recentes
     */
    ...
    /**
     * Calcula o fator de penalidade para um número (0-1)
     * Quanto mais recente, maior a penalidade
     */
    ...
    /**
     * Aplica penalidade de dispersão a um número
     */
    aplicarPenalidade(numero: number, score: number): number {
        const penalidade = this.getPenalidade(numero);
        return score * (1 - penalidade * 0.7); // Reduz até 70%
    }

    /**
     * Define o tamanho da janela de dispersão
     */
