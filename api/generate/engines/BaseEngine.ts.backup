// ============================================
// CAMINHO: api/generate/engines/BaseEngine.ts
// ============================================
...
export abstract class BaseEngine {
    ...
    constructor(dados: number[][], config: EngineConfig, isPro: boolean = false) {
        ...
        // Criar contexto se houver dados suficientes
        if (dados.length >= 10) {
    ...
    /**
     * Método principal que cada engine deve implementar
     */
    abstract gerarJogos(quantidade: number, seed: number, params?: any): EngineResult;

    /**
     * Nome da engine para exibição
     */
    ...
    /**
     * Verifica se a engine está disponível para o usuário
     */
    ...
    /**
     * Adiciona elementos extras ao jogo
     */
    ...
    /**
     * Cria um jogo com números e extras
     */
